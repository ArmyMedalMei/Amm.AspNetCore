...
// 文件名称：StringBuilderExtensions.cs
// 版本号: V1.0.0.0
// 创建时间：2018-12-25 11:17
// 更改时间：2018-12-25 11:19
// ------------------------------------------------------------------------------
...
namespace Amm.AspNetCore.Extentions
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder TrimStart(this StringBuilder sb, char c)
        {
            ...
            if (sb.Length == 0)
                return sb;
            while (c.Equals(sb[0])) sb.Remove(0, 1);
            return sb;
        }
        ...
        public static StringBuilder TrimEnd(this StringBuilder sb, char c)
        {
            ...
            if (sb.Length == 0)
                return sb;
            while (c.Equals(sb[sb.Length - 1])) sb.Remove(sb.Length - 1, 1);
            return sb;
        }
        ...
        public static string SubString(this StringBuilder sb, int start, int length)
        {
            ...
            for (var i = 0; i < length; i++) cs[i] = sb[start + i];
